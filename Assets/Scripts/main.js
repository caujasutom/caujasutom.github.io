...
async function openNav() {
  ...
  if (0 == count) {
      g[0].style.height = "100%", e.style.transform = "rotate(45deg)", b.style.transform = "translateX(1rem)", b.style.opacity = "0.0", f.style.transform = "rotate(-45deg)", await delay(150), h.style.display = "flex", i.style.display = "flex";
      for (var a = 0; a < d.length; a++) d[a].style.display = "flex";
      for (var a = 0; a < c.length; a++) c[a].style.display = "flex";
      count = 1
  } else {
      g[0].style.height = "3.5em", e.style.transform = "rotate(0deg)", b.style.transform = "translateX(0rem)", b.style.opacity = "1.0", f.style.transform = "rotate(0deg)", i.display = "none", h.style.display = "none";
